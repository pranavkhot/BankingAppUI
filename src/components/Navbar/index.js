...
import { Nav, NavbarContainer, NavLogo, MobileIcon, NavMenu, NavItem, NavLinks, NavBtn, NavBtnLink, Shifter} from './NavbarElements'
const Navbar = ({ toggle }) => {
    ...
    return (
       ...
       <Nav scrollNav={scrollNav}>
           <NavbarContainer>
               <NavLogo to='/' onClick={toggleHome}>chime</NavLogo>
